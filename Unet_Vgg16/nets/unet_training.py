...
# from loss.metrics import f_score
import cv2         
...
class Generator(object):
    ...
    def generate(self, random_data = True):
        ...
        while True:
            ...
            # 从文件中读取图像
            jpg = Image.open(r"H:/unet-keras-master/VOCdevkit/VOC2007/JPEGImages/UAV" + '/' + name + ".jpg")
            png = Image.open(r"H:/unet-keras-master/VOCdevkit/VOC2007/SegmentationClass/UAV" + '/' + name + ".jpg")
